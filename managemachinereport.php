...
$pageChange = $sitepath."exportmachinereport.php";
$managePage = "Manage Machine Report";
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable" id="datatable">
						  ...
						  while($row=$rs->fetch_assoc())
						  {
							...
							<tr>
								<td><?= $row["machine"]; ?></td>
								<td><?= $row["requestnos"]*11; ?></td>
								<td><?= $row["actualnos"]; ?></td>
								<td><?= $row["actualnos"] - ( $row["requestnos"] * 11); ?></td>
							</tr>
